    ...
    <>
      ...
      <Modal name="privacy">
        <div className="modal__block modal__block--text" ref={modalRef}>
          <div className="modal__title">Privacy Policy</div>
          <div className="modal__text">
            <p>
              <strong>In brief:</strong> We are GodBot&nbsp;&nbsp;(&quot;GodBot,&quot;
              &quot;we&quot; or &quot;us&quot;). We respect your privacy and work hard to protect
              the confidentiality of information that you give us. We will share your personal data
              with third parties only in the event that it&rsquo;s needed for the provision of
              services and data you have requested (explained in detail in this privacy
              policy).&nbsp;
            </p>
            <h4>About Us</h4>
            <p>
              GodBot is the data controller responsible for your personal data and is the sole owner
              of the GodBot.com website (&quot;Website&quot;), GodBot mobile and desktop
              applications, GodBot services (each, a &quot;Service&quot;) and all of the information
              collected on it. GodBot collects information from users in several ways (explained in
              detail in this privacy policy).
            </p>
            <p>
              This privacy policy applies to personal data that we collect from you when you visit
              this Website, create an account, use our applications or services (&quot;you&quot; or
              &quot;your&quot; being interpreted accordingly). It provides information on what
              personal data we collect, why we collect personal data, how it is used, the lawful
              basis on which your personal data is processed, how it is stored, and how we share
              information.
            </p>
            <p>
              As used in this privacy policy, &quot;personal data&quot; means any information that
              relates to you from which you can be identified.
            </p>
            <p>
              By using our Service or submitting your personal data, you are agreeing to accept the
              terms of this privacy policy, so please read it carefully. If you disagree with this
              privacy policy at any point or time, you should stop using our Services and delete
              your user account.
            </p>
            <h4>Updates</h4>
            ...
            <p>
              During registration you will be required to provide us with your email address;&nbsp;
            </p>
            <p>
            ...
            <p>
              ...
              for further details), browser types, internet service providers, referring pages, exit
            ...
            <p>
              ...
              communications at any time by clicking &quot;unsubscribe&quot; in one of the emails
              (for more information on your rights, please see the &quot;User rights&quot; section
              below).&nbsp;
            </p>
            ...
            <ul>
              <li>
                where we are asked to respond to any of your inquiries, comments, or
                grievances;&nbsp;
              </li>
              <li>
            ...
            <p>
              As used in this privacy policy, &ldquo;legitimate interests&rdquo; means the interests
              of GodBot and our affiliated businesses in conducting and managing our business. When
              we process your personal data for our legitimate interests, we make sure to consider
              and balance any potential impact on you and your rights under data protection laws.
              Our legitimate interests do not automatically override your interests. We do not use
              personal data for activities where our interests override the impact they may have on
              our users, unless we have their explicit consent or those activities are otherwise
              required or permitted by law. You have the right to object to the processing of your
              personal data that is based on our legitimate interests at any time, on grounds
            ...
            <p>
              ...
              payment processor. While on a secure page, such as our order form, the
              &quot;lock&quot; icon in the browser window is displayed, confirming that a secure and
              encrypted connection has been established with the Website. We work hard to ensure
              that our Service is secure and that we meet industry standards. We also use other
              safeguards, such as firewalls, authentication systems (i.e. passwords, and personal
              identification numbers), and access control mechanisms to control unauthorized access
              to systems and data. If you have chosen to create an account, you are responsible for
              doing everything you reasonably can to keep your access details secret. You must not
              share these details with anyone else.
            </p>
            <p>
              We also do our best to protect user information offline. All of our users&apos;
              personal information is restricted to our offices. Only employees who need to see the
            ...
            <p>
              <strong>EEA and UK users&apos; specific rights</strong>
            </p>
            <p>
              Individuals subject to European and United Kingdom (&quot;UK&quot;) data protection
              laws may have data subject rights in relation to the personal data we hold on them
              (described in detail below). This may, in and of itself, be subject to limitations
              and/or restrictions.
            </p>
            ...
            <p>
              <strong>Restricting the processing of personal data</strong>
            </p>
            <p>
              You may ask us to restrict or &lsquo;block&rsquo; the processing of your personal data
              in certain circumstances, for example, if you contest the accuracy of the data or
              object to us processing it. We will notify you before we lift any restriction on
              processing. If we share your personal data with others, we will notify them of the
              restriction wherever possible. If prompted, and if it is possible and lawful to do so,
              we will also notify you with whom we have shared or will share your personal data so
            ...
            <ul>
              <li>
                ...
                not be a problem unless we demonstrate compelling legitimate grounds for
                processing;&nbsp;
              </li>
              <li>
                object to our processing of your data for the purposes of direct marketing at any
                time. This can be done by clicking the &quot;unsubscribe&quot; button in our
            ...
            <p>
              ...
              please contact us at privacy@godbot.pro (please note that we do not provide user or
              account support via email, this address is for privacy inquiries only).
            </p>
          </div>
