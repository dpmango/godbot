    ...
    <div className="authorization__swiper">
      <Swiper
        ...
        <SwiperSlide>
          ...
          <img src="http://localhost:3000/images/autho-1.svg" alt="Slider image" />
        ...
        <SwiperSlide>
          ...
          <img src="http://localhost:3000/images/autho-2.svg" alt="Slider image" />
          <p className="authorization__text">
        ...
        <SwiperSlide>
          ...
          <img src="http://localhost:3000/images/autho-3.svg" alt="Slider image" />
          <p className="authorization__text">
        ...
        <SwiperSlide>
          ...
          <img src="http://localhost:3000/images/autho-4.svg" alt="Slider image" />
          <p className="authorization__text">
        ...
        <SwiperSlide>
          ...
          <img src="http://localhost:3000/images/autho-5.svg" alt="Slider image" />
          <p className="authorization__text">
