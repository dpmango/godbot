...
export const ChartTable: React.FC<{
...
}> = ({ data, handleEditChart }) => {
  const [legendPopup, setLegendPopup] = useState<boolean>(false);
  ...
  return (
    <div className="chart__head">
      ...
      <button className="chart__settings" onClick={handleLegendClose}>
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
