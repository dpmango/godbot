...
export const Echrt: React.FC<{containerWidth: number; axisColor: string}> = ({containerWidth, axisColor}) => {
	...
	const initChart = async () => {
		...
		window.onresize = function () {
			setChartWidth(document.querySelector('.table__inner')?.clientWidth as number);
			graph.resize();
		};
	};
