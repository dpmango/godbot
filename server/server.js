...
const recomendatios = [
	{
		date: '15.07.22 12:48:01',
		currency: 'Dogecoin',
		shortname: 'ETH',
		icon: 'ETH.svg',
		direction: 'LONG',
		status: 'Закрыта по стопу',
		order_benefit: '-15%',
		entry_price_range: ['19,481.29', '19,481.29', '19,481.29', '19,481.29', '19,481.29', '19,481.29'],
		get_exit_range: ['19,481.29', '19,481.29', '19,481.29', '19,481.29', '19,481.29', '19,481.29'],
		stop_loss: 0.0,
		trigger_stop: '$19,481.29',
		risk: 45
	}
];
...
const dataHour = [
	{
		name: 'series-1',
		data: [3235440, 40123431, 33125345, 53245310, 44532119, 604331, 7324310, 9451312, 123515]
	},
	{
		name: 'series-2',
		data: [3312310, 5543210, 343543, 35234203, 4312934, 6203211, 712101, 9322321, 1232315]
	},
	{
		name: 'series-3',
		data: [331110, 554120, 34335, 355203, 439334, 622011, 713101, 93221, 123135]
	},
	{
		name: 'series-4',
		data: [3354110, 55434510, 3431235, 35232103, 43123934, 6201321, 7313201, 93423221, 12313215]
	},
	{
		name: 'series-5',
		data: [3312310, 55321410, 343511, 3520323, 43123934, 620111, 7310121, 9332221, 1234315]
	}
];
